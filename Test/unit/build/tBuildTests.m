...
%tBuildTests Unit tests for the tests parameter in prodserver.mcp.build.
    ...
    methods(Test)
        ...
        function testsGeneratesDefinition(test)
            ...
            prodserver.mcp.build(fcn, ...
                tests=@() schemaComputeNoBlock(1.0, 2.0, 3.0), ...
                wrapper="None", folder=test.tempFolder, ...
        ...
        function testsAndDefinitionErrors(test)
            ...
            test.verifyError(...
                @() prodserver.mcp.build(fcn, ...
                    tests=@() schemaComputeNoBlock(1.0, 2.0, 3.0), ...
                    definition=defs, wrapper="None", ...
                    folder=test.tempFolder, archive="conflict"), ...
                "prodserver:mcp:TestsDefinitionConflict");
        end
        ...
        function testsEmptyNoEffect(test)
            ...
            fcn = "schemaCompute";
            prodserver.mcp.build(fcn, tests=[], ...
                wrapper="None", folder=test.tempFolder, ...
        ...
        function testsMultiToolBuild(test)
            ...
            prodserver.mcp.build(fcns, ...
                tests=@() exerciseMultiTool(), ...
                wrapper=["None","None"], folder=test.tempFolder, ...
