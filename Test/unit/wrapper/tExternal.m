...
% Copyright 2025-2026 The MathWorks, Inc.
    ...
    methods (Test)
        ...
        function optionalAndExternal(test)
            ...
            fzd = strtrim(erase(fzd,MCPConstants.WireEncodingOutputMsg));
            ...
            fmd = strtrim(erase(fmd,MCPConstants.WireEncodingOutputMsg));
            ...
            fpd = strtrim(erase(fpd,MCPConstants.WireEncodingInputMsg));
            ...
            ftd = strtrim(erase(ftd,MCPConstants.WireEncodingInputMsg));
