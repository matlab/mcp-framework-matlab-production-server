...
% Example:
%
%    [vectors,bbox]=snowflake(6,300,300);
%
...
% Koch snowflake, scaled to fit inside a 300 x 300 rectangle.
  ...
  arguments(Input)
      ...
      height (1,1) double % Maximum height of the bounding box.
  end
  arguments(Output)
      % Turtle graphics vector list defining the fractal snowflake.
      vectors int32 
      % Actual bounding box. Less than or equal to width-by-height.
