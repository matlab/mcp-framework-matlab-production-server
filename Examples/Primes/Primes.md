...
The [prodserver.mcp.call](../../docs/reference/call.md) function performs these steps according to the MCP protocol. Therefore, if the function returns the expected result, you can be confident that other MCP clients will be able to successfully use this MCP tool.
